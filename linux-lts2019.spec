...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.4.21.tar.xz
Source1:        config
Source2:        cmdline

%define ktarget  lts2019
...
Requires: linux-lts2019-license = %{version}-%{release}
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-lts2019 = %{version}-%{release}
Requires:       linux-lts2019-extra = %{version}-%{release}
Requires:       linux-lts2019-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-lts2019
cp COPYING %{buildroot}/usr/share/package-licenses/linux-lts2019/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-lts2019
...
/usr/share/package-licenses/linux-lts2019
